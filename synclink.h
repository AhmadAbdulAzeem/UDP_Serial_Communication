 ...
 *
 * Copyright (C) 1998-2016 by Microgate Systems, Ltd
 *
...
#define MGSL_INTERFACE_RTS_EN      (1 << 4)
#define MGSL_INTERFACE_LL          (1 << 5)
#define MGSL_INTERFACE_RL          (1 << 6)
#define MGSL_INTERFACE_MSB_FIRST   (1 << 7)
#define MGSL_INTERFACE_HALF_DUPLEX (1 << 8)
#define MGSL_INTERFACE_TERM_OFF    (1 << 9)

#define MGSL_DISABLE     0
#define MGSL_ENABLE      1
#define MGSL_ENABLE_PIO  ((1 << 31) + 1)
#define MGSL_ENABLE_DMA  ((1 << 30) + 1)
...
#define MGSL_IOCSTDM            _IO(MGSL_MAGIC_IOC,23)
#define MGSL_IOCGTDM            _IO(MGSL_MAGIC_IOC,24)
